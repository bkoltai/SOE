...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/bond/completions/hirb.rb", "lib/hirb/console.rb", "lib/hirb/dynamic_view.rb", "lib/hirb/formatter.rb", "lib/hirb/helpers/auto_table.rb", "lib/hirb/helpers/object_table.rb", "lib/hirb/helpers/parent_child_tree.rb", "lib/hirb/helpers/table/filters.rb", "lib/hirb/helpers/table/resizer.rb", "lib/hirb/helpers/table.rb", "lib/hirb/helpers/tree.rb", "lib/hirb/helpers/unicode_table.rb", "lib/hirb/helpers/vertical_table.rb", "lib/hirb/helpers.rb", "lib/hirb/import_object.rb", "lib/hirb/menu.rb", "lib/hirb/pager.rb", "lib/hirb/string.rb", "lib/hirb/util.rb", "lib/hirb/version.rb", "lib/hirb/view.rb", "lib/hirb/views/couch_db.rb", "lib/hirb/views/misc_db.rb", "lib/hirb/views/mongo_db.rb", "lib/hirb/views/orm.rb", "lib/hirb/views/rails.rb", "lib/hirb/views.rb", "lib/hirb.rb", "lib/ripl/hirb.rb", "test/auto_table_test.rb", "test/console_test.rb", "test/dynamic_view_test.rb", "test/formatter_test.rb", "test/hirb_test.rb", "test/import_test.rb", "test/menu_test.rb", "test/object_table_test.rb", "test/pager_test.rb", "test/resizer_test.rb", "test/table_test.rb", "test/test_helper.rb", "test/tree_test.rb", "test/util_test.rb", "test/view_test.rb", "test/views_test.rb", "LICENSE.txt", "CHANGELOG.rdoc", "README.rdoc", "test/deps.rip", "Rakefile", ".gemspec"]
